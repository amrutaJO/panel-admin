        ...
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-header-title d-flex align-items-center gap-3">
                    <span><?= translate('notification_management') ?></span>
                </h1>
            </div>
    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-bordered table-nowrap table-align-middle">
            <thead class="thead-light " align="left">
                ...
                <tr>
                    <th><?= translate('id') ?></th> <!-- newly added -->
                    <th><?= translate('user id') ?></th> <!-- newly added -->
                    <th><?= translate('partner id') ?></th>
                    <th><?= translate('status') ?></th> <!-- newly added -->
                    <th><?= translate('message') ?></th>
                    <th><?= translate('created_at')?></th> <!-- newly added -->
                    <th><?= translate('delivered_at') ?></th> <!-- newly added -->
