...
<head>
  ...
  <!-- Title -->
    <title>Reset Password | Nursery Solution</title>
  <!-- Favicon -->
          ...
          <div class="card-body">
            ...
            <form class="js-validate needs-validation" novalidate>
              ...
              <div class="mb-4">
                ...
                <input type="email" class="form-control form-control-lg" name="email" id="resetPasswordSrEmail" tabindex="1" placeholder="user@example.com" aria-label="user@example.com" required>
              ...
              <div class="d-grid gap-2">
                ...
                <div class="text-center">
                  <a class="btn btn-link" href="login.php">
                    <i class="bi-chevron-left"></i> Back to Login                  </a>
                </div>
              </div>
            </form>
            <!-- End Form -->
